...
(function (global) {
  ...
  global.RandomEngineReference = [
    ...
    ['Maths', [
      ...
      ['2d6~/2', 'divide, keeping the whole part', 'suffix', 'The fraction is thrown away, toward zero, so 7/2 is 3. With % this reads the digits of a roll: d100/10 is the tens, d100%10 the units.'],
      ['2d6~/2.0', 'divide, keeping the fraction', 'suffix', 'A written . is how you ask for a real answer: 7/2 is 3 and 7/2.0 is 3.5. Nothing else makes a fraction, so 5d20dhdl/3.0 averages the middle three dice and 5d20dhdl/3 does not. Results are shown to the hundredth.'],
